...
local function run(msg, matches)
  if matches[1]:lower() == 'blacklifetg' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "blacklifetg" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) ([Bb]lacklife[Tt][Gg])",-- Put everything you like :)
		"^[!/]([Bb]lacklife[Tt][Gg])"-- Put everything you like :)
    }, 
  run = run
}
